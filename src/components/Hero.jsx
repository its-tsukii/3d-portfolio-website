...
import profilePic from "../assets/home3.jpeg"
  ...
  return (
    <div className="border-b border-neutral-900 pb-4 lg:mb-35">
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2 xl:w-1/2 p">
        <div className="flex flex-col items-center lg:items-start">
            <motion.h1 variants={container(0)}
              initial="hidden"
              animate="visible"
              className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Aayush Kukade</motion.h1>
            <motion.span variants={container(0.5)}
              ...
              animate="visible" className="bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-3xl tracking-tight text-transparent">
                🚀 Aspiring Cloud Engineer | DevOps Intern | SRE Learner !
            </motion.span>
